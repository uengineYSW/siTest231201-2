...
pluralCaseList.push( {plural: "orderAndPaymentManagements/orders", pascal: "OrderAndPaymentManagementOrder"} )

pluralCaseList.push( {plural: "menuAndRestaurantManagements/restaurants", pascal: "MenuAndRestaurantManagementRestaurant"} )

pluralCaseList.push( {plural: "deliveryAndOrderStatusManagements/deliveries", pascal: "DeliveryAndOrderStatusManagementDelivery"} )

pluralCaseList.push( {plural: "systemManagements/administrators", pascal: "SystemManagementAdministrator"} )
