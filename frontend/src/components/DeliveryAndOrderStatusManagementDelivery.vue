<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <deliveryStatusType offline label="undefined 유형" v-model="value.deliveryStatusType" :editMode="editMode" @change="change"/>
        </v-card-text>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openAssignDelivery"
            >
                AssignDelivery
            </v-btn>
            <v-dialog v-model="assignDeliveryDiagram" width="500">
                <AssignDeliveryCommand
                    @closeDialog="closeAssignDelivery"
...
<script>
    ...
    export default {
        name: 'DeliveryAndOrderStatusManagementDelivery',
        components:{
        },
        props: {
	...
	async created() {
        ...
        methods: {
            ...
            openAssignDelivery() {
                this.assignDeliveryDiagram = true;
            },
            closeAssignDelivery() {
                this.assignDeliveryDiagram = false;
            },
        },
    }
</script>
