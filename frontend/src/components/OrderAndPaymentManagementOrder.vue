<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="RestaurantId" v-model="value.restaurantId" :editMode="editMode" :inputUI="''"/>
            ...
            <paymentMethodType offline label="undefined 유형" v-model="value.paymentMethodType" :editMode="editMode" @change="change"/>
            <String label="PaymentStatus" v-model="value.paymentStatus" :editMode="editMode" :inputUI="''"/>
            <paymentStatusType offline label="undefined 유형" v-model="value.paymentStatusType" :editMode="editMode" @change="change"/>
            <String label="OrderStatus" v-model="value.orderStatus" :editMode="editMode" :inputUI="''"/>
            <orderStatusType offline label="undefined 유형" v-model="value.orderStatusType" :editMode="editMode" @change="change"/>
        </v-card-text>
...
<script>
    ...
    export default {
        name: 'OrderAndPaymentManagementOrder',
        components:{
            Address,
        },
        props: {
